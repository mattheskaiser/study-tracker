...
import { CourseColumnOrganism } from "@/components/organisms/CourseColumn.organism";
...
export const SemesterViewOrganism = ({ coursesBySemester, translation }: SemesterViewProps) => {
